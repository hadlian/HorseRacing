...
- For R5 scoring columns needed in Sheet 2 (model_rank, comp, tier), use the extended SELECT from Section 4 — not the shorter tracker version from Section 8.
...
*Spec version: v1.3 — 2026-05-20*
*Changes from v1.2: meta write step restored in Section 9; extended SELECT note added to Section 10 Data Sources pointing to Section 4 for model_rank/comp/tier columns*
